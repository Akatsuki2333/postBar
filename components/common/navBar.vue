    ...
    <div id="top" ref="top" :modal-append-to-body="false">
        ...
        <div id="top-banner" :modal-append-to-body="false">
            <ul id="top-banner-list">
                ...
                <li class="after banner-list">

                    <el-button type="text" @click="dialogFormVisible = true" class="top-banner-link top-banner-link-login">登录</el-button>
                    ...
                    <el-dialog :visible.sync="dialogFormVisible" :modal-append-to-body='false'>
                        <div id="login-layout" ref="login">
                            ...
                            <div class="login-bottom">
                                ...
                                <router-link :to="{name : 'register'}" class="login-link login-register">立即注册</router-link>
                            </div>
                        </div>
                    </el-dialog>
                ...
                <li class="after banner-list">
                    <router-link :to="{name : 'register'}" class="top-banner-link" target="_blank">注册</router-link>
                </li>
    ...
    export default {
        ...
        methods: {
            ...
            login(){
                ...
                this.$ajax.post("/user/login",JSON.parse(obj))
