            ...
            <div id="content">
                ...
                <div id="sidebar">
                    <ul>
                        ...
                        <li class="sidebar-icon" @click="refresh"></li>
                        ...
                        <li class="sidebar-icon"></li>
                        <li class="sidebar-icon" @click="scrollTop"></li>
                    </ul>
                </div>
                ...
                <div id="comment">
                    <ul class="comment-left">
                        ...
                        <li class="comment-stick">
                            ...
                            <span class="comment-stick-user"><i  class="comment-stick-icon comment-stick-icon3"></i>翁楚钦</span>
                        </li>
                        ...
                        <li class="comment-normal">
                            ...
                            <ul class="comment-detail">
                                ...
                                <li class="sofa"><i class="comment-stick-icon comment-stick-icon5"></i><i class="name">方晓纯呵呵打好的哈给把</i><i class="time">16:03</i></li>
...
<style scoped>
    ...
    /*沙发部分信息*/
    #comment .comment-normal .sofa{
        float: left;
        margin-left: 20px;
        color: #989898;
        line-height: 14px;
    }
    #comment .comment-normal .sofa .comment-stick-icon5 {
        width: 10px;
        height: 20px;
        margin-right: 5px;
        background: url(../../src/static/imgs/thread_list.png) no-repeat -5px -57px;
    }
    #comment .comment-normal .sofa .name {
        display: inline-block;
        width: 51px;
        white-space: nowrap;
        text-overflow: ellipsis;
    ...
    #comment .comment-normal .sofa .time {
        display: inline-block;
        margin-left: 50px;
    }
